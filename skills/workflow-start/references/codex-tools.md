...
Claude Code skills reference named agent types like `workflow-code-reviewer`.
...
|-------------------|------------------|
| `Task tool (workflow-code-reviewer)` | `spawn_agent(agent_type="worker", message=...)` with `code-reviewer.md` content |
...
See `workflow-using-git-worktrees` Step 0 and `workflow-finishing-a-development-branch`
